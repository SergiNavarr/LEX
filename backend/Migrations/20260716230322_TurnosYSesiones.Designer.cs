...
namespace Lex.Api.Migrations
{
    ...
    [Migration("20260716230322_TurnosYSesiones")]
    partial class TurnosYSesiones
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lex.Api.Domain.Entities.DisponibilidadEstudiante", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("EstudianteId", "DiaSemana");

                    b.ToTable("disponibilidad_estudiante");
                });
            ...
            modelBuilder.Entity("Lex.Api.Domain.Entities.Sesion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Lex.Api.Domain.Entities.Turno", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("NotasEstudiante")
                        .HasColumnType("text")
                        .HasColumnName("notas_estudiante");

                    b.HasKey("Id");

                    b.HasIndex("ClienteId", "FechaHoraInicio");

                    b.HasIndex("EstudianteId", "FechaHoraInicio");
            ...
            modelBuilder.Entity("Lex.Api.Domain.Entities.Sesion", b =>
                {
                    ...
                    b.HasOne("Lex.Api.Domain.Entities.Turno", "Turno")
                        .WithOne("Sesion")
                        .HasForeignKey("Lex.Api.Domain.Entities.Sesion", "TurnoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
